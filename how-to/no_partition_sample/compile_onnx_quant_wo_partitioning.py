...
from dummy_onnx_gen import dummy_onnx_gen
...
if __name__ == "__main__":
    ...
    dummy_onnx_path = current_dir+"/dummy_onnx_for_tvm.onnx"
    dummy_onnx_gen(model_file,dummy_onnx_path)
    os.environ["IN_ONNX_8888"] = model_file
    print(f"dummy onnx : {dummy_onnx_path}")
    model_file = dummy_onnx_path
    ...
    if opts["qat"]: # Quantize Aware Traning model 
        ...
        mod, params = mera2.from_onnx_qat(model_file, shape_dict, \
                                          qat_type, \
        ...
        # 3.2.2 Run the backend compiler for x86 and generate calibaration data.
    ...
    print("[WARNING] If DRP Pre-processing is required, please modify this script. ")
    """
