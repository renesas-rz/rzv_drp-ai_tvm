...
ORG_ONNX=${MODEL_DIR}/${INPUT}/org_model.onnx
mv ${MODEL_DIR}/${INPUT}/model.onnx $ORG_ONNX

python3 rename_onnx_in_out.py $IN_ONNX_8888 $ORG_ONNX ${MODEL_DIR}/${INPUT}/model.onnx
