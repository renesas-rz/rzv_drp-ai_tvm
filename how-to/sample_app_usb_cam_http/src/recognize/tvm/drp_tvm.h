...
class TVMModel : public IRecognizeModel
{
private:
...
#else
    constexpr static string_view TVM_MODEL_DIR = "face_deeppose_pt_fhd";
    ...
    constexpr static string_view MODEL_NAME = "face_deeppose_pt";
