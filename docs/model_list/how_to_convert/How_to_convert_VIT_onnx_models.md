# How to convert ViT_onnx models
<!-- Below is a list of AI models supported by this manual. -->
The AI models in the table below should be converted according to the following procedure and then entered into the compilation script.

| AI model                   | Download model name             |Input shape    | Task                 |
|----------------------------|---------------------------------|---------------|----------------------|
| Vision Transformer(tiny)   | vit_tiny_patch16_224            |(1,3,224,224)  | Image Classification |
| Vision Transformer(small)  | vit_small_patch16_224           |(1,3,224,224)  | Image Classification |
---

License: [Apache 2.0](https://huggingface.co/timm)
...
pip install torch==2.1.2 torchvision==0.16.2 onnx==1.16.0 onnxruntime==1.20.1 numpy==1.26.4 matplotlib==3.10.3 pandas==2.2.3 protobuf==3.20.* timm==1.0.9 onnxsim
```
...
onnxsim output/vit_base_patch16_224_onnx/vit_base_patch16_224.onnx output/vit_base_patch16_224_onnx/vit_base_patch16_224.onnx 
```
