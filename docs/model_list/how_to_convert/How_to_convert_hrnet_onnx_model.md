# How to convert hrnet_onnx model
<!-- Below is a list of AI models supported by this manual. -->
The AI models in the table below should be converted according to the following procedure and then entered into the compilation script.

| AI model                                                                                                                                     | Download model name             | Task              |
|----------------------------------------------------------------------------------------------------------------------------------------------|---------------|-------------------|
| HRNet                                                        |hrnet                          | Body Keypoint 2D     |
---

License: Apache 2.0 ([mmcv](https://github.com/open-mmlab/mmcv.git), [mmdetection](https://github.com/open-mmlab/mmdetection.git), [mmpose](https://github.com/open-mmlab/mmpose.git), [mmdeploy](https://github.com/open-mmlab/mmdeploy.git))
...
pip install mmpose torch==2.1.2 torchvision==0.16.2 opencv-python==4.11.0.86 numpy==1.26.4
