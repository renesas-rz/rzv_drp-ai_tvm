...
If you would like to view tutorials for previous versions, please see [here](./compile_your_own_model_v230.html).
...
Resnet18 was used as a sample model in the "How to Compile Sample Model". In this page, it is explained how to change from Resnet18 to YOLOX as an example.  
...
For example, you can modify a script like below.  
By default, it uses the USB camera, but here we will change it to use a MIPI camera.
...
> $TRANSLATOR/../onnx_models/YoloX-S_VOC_sparse70.onnx \　# target model file to compile
...
If you do not have C++ implementation of your model's pre/post-processing, you can use the following applications:
- [Validation Application](https://github.com/renesas-rz/rzv_drp-ai_tvm/tree/main/how-to/validation): A C++ program to run inference without pre/post-processing. Profiling data can also be generated.
- [Python API Sample Script](https://github.com/renesas-rz/rzv_drp-ai_tvm/tree/main/how-to/python): A Python script to run inference without pre/post-processing. Scripts for ResNet and YOLOX pre/post-processing are also provided.
...
$ scp ./sample_yolox_cam/ root@192.168.1.11:/root
{% endhighlight %}
...
root@rzv2h-evk...:# tar xvfz sample_yolox.tar.gz
root@rzv2h-evk...:# cd sample_yolox_cam/
root@rzv2h-evk...:# export LD_LIBRARY_PATH=.
root@rzv2h-evk...:# ./app_yolox_cam
{% endhighlight %}
