...
If you would like to view tutorials for previous versions, please see [here]({{ site.baseurl }}/pruning_v230.html).
...
{% highlight console %}
$ ls
drpai-extension-pack_ver1.3.0.tar.gz  torch.Dockerfile
{% endhighlight %}
...
drpai_ext_pt_img                  latest                              XXXXXXXXXXXXX        X seconds ago       13.62-1. Prepare the datasets and pre-trained model for your own model
GB
{% endhighlight %}
...
To find more details please visit [https://www.robots.ox.ac.uk/~vgg/projects/pascal/VOC/](https://www.robots.ox.ac.uk/~vgg/projects/pascal/VOC/).  
